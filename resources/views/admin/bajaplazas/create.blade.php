        ...
        <div class="panel panel-primary "> 
           ...
           <div class="panel panel-info">
                ...
                <div class="panel-body">                 
                        ...
                        <div id="DesingForm">
                                {!! Form::model(['route' => 'bajaplazas.store', 'method'=>'post']) !!}
                        
                                                <!-- 'enctype'=>'multipart/form-data' 'onsubmit'=>'return Validation()' -->
                                    <input type="hidden" name="_token" value="{{ csrf_token()}}">
                                    <div class="form-group" >
                                        <label for="formEmail">Nombres</label>                                       
                                          <input type="text" class="form-control" id="txtnombres" disabled="" value="">                                          
                                        
                                          <input type="hidden" class="form-control" id="IdPersona"    disabled="" value="">
                                          <input type="hidden" class="form-control" id="IdEstructura" disabled="" value="">
                                          <input type="hidden" class="form-control" id="IdCargo"      disabled="" value="">
                                          <input type="hidden" class="form-control" id="NroPlaza"     disabled="" value="">
                                          
                                    </div>

                                    <div class="form-group" >
                                        <label for="formEmail"># Plaza / Nivel / Cargo</label>
                                          <input type="text" class="form-control" id="txtIdPlaza" disabled="" value="">
                                    </div>
                                    <div class="form-group">
                                        <label for="formEmail">Dependencia</label>
                                         <input type="text" class="form-control" id="txtIdEstructura" disabled="" value="">
                                    </div>

                                    <div class="form-group">
                                        <label for="formEmail">Motivo de Bja</label>
                                         <select id="IdTipoMov" class="form-control select2" name="select_4dig">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text"  class="form-control" name="FechaDocRef" id="datetime1"/> <!-- FechaDocRef-->
                                            </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="formPassword">Doc. de Referencia(Resolución)</label>
                                        <input type="text" class="form-control" id="DocRef" value="xyz">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="formPassword">Adjuntar Doc.</label>
                                        <input type="text" class="form-control" id="FileAdjunto" value="">
                                    </div>

                                     <div class="form-group">
                                        <label for="formPassword">Observación</label>                          
                                            <textarea id="Observacion" rows="3" class="form-control resize_vertical "></textarea>                           
                                    </div>
