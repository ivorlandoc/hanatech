                                ...
                                {!! Form::model($user, ['url' => URL::to('admin/users/'. $user->id.''), 'method' => 'put', 'class' => 'form-horizontal','id'=>'commentForm', 'enctype'=>'multipart/form-data','files'=> true]) !!}
                                    ...
                                    <div id="rootwizard">
                                        <ul>
                                            ...
                                            <li><a href="#tab2" data-toggle="tab">Biografia</a></li>
                                            <li><a href="#tab3" data-toggle="tab">Dirección</a></li>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane" id="tab1">
                                                ...
                                                <div class="form-group {{ $errors->first('password', 'has-error') }}">
                                                    <p class="text-warning">Si no quieres cambiar la contraseña ... déjala en blanco</p>
                                            ...
                                            <div class="tab-pane" id="tab2" disabled="disabled">
                                                ...
                                                <div class="form-group {{ $errors->first('pic_file', 'has-error') }}">
                                                    ...
                                                    <span class="btn btn-default btn-file">
                                                        ...
                                                        <span class="fileinput-exists">Cambie</span>
                                                        <input id="pic" name="pic_file" type="file"
                                                               class="form-control"/>
                                                    </span>
                                                                <a href="#" class="btn btn-default fileinput-exists" data-dismiss="fileinput" style="color: black !important;">Elimanar</a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form-group  {{ $errors->first('pic', 'has-error') }}">
                                                    <label for="bio" class="col-sm-2 control-label">Biografia <small>(breve introducción)</small></label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group {{ $errors->first('gender', 'has-error') }}">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-control" title="Select Gender..." name="gender">
                                                            ...
                                                            <option value="female" @if($user->gender === 'female') selected="selected" @endif >Femenino</option>
                                            ...
                                            <div class="tab-pane" id="tab4" disabled="disabled">
                                                <p class="text-danger"><strong>Tenga cuidado con la selección de grupo, si le da acceso de administrador ... pueden acceder a la sección de administración</strong></p>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <span>Para activar su cuenta, haga clic en la casilla de verificación</span>
                                                    </div>
                                                </div>
                                            </div>
