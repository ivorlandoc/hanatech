                        ...
                        <form id="commentForm" action="{{ route('admin.users.store') }}"
                            ...
                            <div id="rootwizard">
                                <ul>
                                    ...
                                    <li><a href="#tab4" data-toggle="tab">Gropo de Usuario</a></li>
                                </ul>
                                ...
                                <span class="btn btn-default btn-file">
                                    ...
                                    <input id="pic" name="pic_file" type="file" class="form-control"/>
                                        ...
                                        <div class="form-group">
                                            <label for="bio" class="col-sm-2 control-label">Biografia <small>(brief intro) *</small></label>
                                            <div class="col-sm-10">
                        <textarea name="bio" id="bio" class="form-control resize_vertical"
                                  rows="4">{!! old('bio') !!}</textarea>
                                    ...
                                    <div class="tab-pane" id="tab3" disabled="disabled">
                                        ...
                                        <div class="form-group">
                                            <label for="postal" class="col-sm-2 control-label">Cod-Postal/zip</label>
                                            <div class="col-sm-10">
