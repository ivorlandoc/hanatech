           ...
           <div class="panel panel-info" id="idheadinformcion">
                ...
                <div class="panel-body"> 
                    ...
                    <div  id="IdFormbodyalta">
                         {{ Form::open(array( 'route' => ['get-datos-paraintegra'], 'method' => 'post', 'id' => 'frmintegra','name' => 'frmintegra'))}}                       
                        ...
                        {{ Form::open(array( 'route' => ['save-paraintegra-plazas','0'], 'method' => 'post', 'id' => 'frmintegrasave','name' => 'frmintegrasave'))}} 
                                <!-- ==========draw table========== -->
                                 <input type="hidden" name="token" value="{{ csrf_token()}}"> 
                                 ...
                                 <div class="form-group">                                   
                                        <select id="_selectMotivo" class="form-control select2" name="_selectMotivo">
                                            ...
                                            @foreach($data as $keys) 
                                                <option value="{{ $keys->IdTipoMov }}">{{ $keys->IdTipoMov }} | {{ $keys->Descripcion }}</option>
                                            @endforeach
                                        </select>  
                                </div>
                               ...
                               <div class="input-group select2-bootstrap-append"> 
                                    <div class="btn-group btn-group-lg">
                                        ...
                                        <a href="{{ URL::to('admin/integra') }}" class="alert alert-info alert-dismissable margin5" id="SalirIntegra" >Nuevo | Salir</a>
                                    </div> 
                                </div>
