           ...
           <div class="panel panel-info" id="idheadinformcion">
                ...
                <div class="panel-body"> 
                    ...
                    <div  id="IdFormbodyalta">
                         <?php echo e(Form::open(array( 'route' => ['set-save-contador_plaza','0','1'], 'method' => 'post', 'id' => 'frmcreaplz','name' => 'frmcreaplz'))); ?>                       
                            ...
                            <div id="FormAltaPlaza">
                                  <div class="form-group">                               
                                    ...
                                    <div class="input-group select2-bootstrap-append"> 
                                        ...
                                        <div class="form-group"> 
                                         <?php $__currentLoopData = $conta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                    
                                            <select id="selereg" class="form-control select2" name="selereg" onclick="SetNroPlaza()" >                                                
                                                <option value="1" style="width:80px;border: 0px;font-weight:bold;font-size:15px;">REG. 728: <?php echo e($key->r728); ?> </option>
                                                <option value="0" style="width:80px;border: 0px;font-weight:bold;font-size:15px;">REG. CAS:<?php echo e($key->rcas); ?>9</option>
                                            </select>  
                                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                           <input type="hidden" class="form-control" id="regtxt728" value="<?php echo e($key->r728); ?>">
                                            <input type="hidden" class="form-control" id="regtxtcas" value="<?php echo e($key->rcas); ?>">
                                        </div>
                                ...
                                <div class="form-group">                                   
                                        <select id="selNivel" class="form-control select2" name="selNivel" onchange="SetNroPlaza()" >
                                            ...
                                            <?php $__currentLoopData = $allNivel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keys): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                                <option value="<?php echo e($keys->IdNivel); ?>"><?php echo e($keys->IdNivel); ?> | <?php echo e($keys->Descripcion); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>  
                                </div>
                                ...
                                <div class="form-group">                                                                       
                                    <select id="selecargo" class="form-control select2" name="selecargo" >
                                        ...
                                        <?php $__currentLoopData = $allCargo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keys): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                                <option value="<?php echo e($keys->IdCargo); ?>"><?php echo e($keys->IdCargo); ?> | <?php echo e($keys->Descripcion); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                               ...
                               <div class="input-group select2-bootstrap-append"> 
                                    <div class="btn-group btn-group-lg">
                                        ...
                                        <a href="<?php echo e(URL::to('admin/creaplaza')); ?>" class="alert alert-info alert-dismissable margin5" id="SalirCrea" >Nuevo [Salir]</a>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="table-responsive" >
                                           <?php echo e(Form::open(array('route' => ['get-all-estruct','0'], 'method' => 'post', 'id' => 'frmgetEstru','name' => 'frmgetEstru'))); ?>  
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">                          
                                                        <select id="select_nivel1" class="form-control select2" name="select_nivel1" onchange="GetSelEstructura(2)">
                                                            ...
                                                            <option value="<?php echo e($keys->IdEstructura); ?>"><?php echo e($keys->IdEstructura); ?> | <?php echo e($keys->Descripcion); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
...
<script type="text/javascript" src="<?php echo e(asset('assets/js/js-crea-plaza.js')); ?>"> </script>
