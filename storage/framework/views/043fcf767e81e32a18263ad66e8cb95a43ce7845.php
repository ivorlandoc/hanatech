...
<!-- ========================-->
 <link href="<?php echo e(asset('assets/vendors/modal/css/component.css')); ?>" rel="stylesheet"/>
 <link href="<?php echo e(asset('assets/css/pages/advmodals.css')); ?>" rel="stylesheet"/>
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/vendors/awesomeBootstrapCheckbox/awesome-bootstrap-checkbox.css')); ?>"/>
                        ...
                        <!-- ========== Load dependencia ============ -->
                            ...
                            <div id="FormAltaPlaza">
                                ...
                                <div class="btn-group btn-group-lg">
                                    ...
                                    <a href="<?php echo e(URL::to('admin/altaplaza')); ?>" class="alert alert-info alert-dismissable margin5" id="SalirAlta" >Nuevo [Salir]</a>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="table-responsive" >
                                        <!-- ================= inicio search ===================-->
                                        <div class="input-group select2-bootstrap-append">                          
                                             <?php echo Form::text('search_persona',null, ['class'=>'form-control','placeholder'=>'Apellidos y Nombres | Dni Plaza','type'=>'search','id'=>'search_persona']); ?>  
                                                    <input type="hidden" name="token" value="<?php echo e(csrf_token()); ?>">                   
                                                    <span class="input-group-btn">
                                                        <button class="btn btn-default" type="button" data-select2-open="single-append-text">
                                                            <span class="glyphicon glyphicon-search"></span>
...
<script type="text/javascript" src="<?php echo e(asset('assets/js/api-estructura.js')); ?>"> </script>
<script type="text/javascript" src="<?php echo e(asset('assets/js/api-altaplaza.js')); ?>"> </script>
  <script language="javascript" type="text/javascript" src="<?php echo e(asset('assets/js/pages/radio_checkbox.js')); ?>"></script>
