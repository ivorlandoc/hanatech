...
<link rel="stylesheet" href="<?php echo e(asset('assets/vendors/Buttons/css/buttons.css')); ?>" />
<link rel="stylesheet" href="<?php echo e(asset('assets/css/pages/buttons.css')); ?>" />
<link rel="stylesheet" href="<?php echo e(asset('assets/css/pages/advbuttons.css')); ?>" />
        ...
        <div class="panel panel-primary "> 
           ...
           <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <div id ="GetSearch">
                        <?php echo Form::open(['route'=>'admin.bajaplazas.index','method'=>'GET','id'=>'BajaPlazas']); ?>

                            <input type="hidden" name="token" value="<?php echo e(csrf_token()); ?>">
                            <div class="form-group">                            
                                <div class="input-group select2-bootstrap-append">                          
                                            <?php echo Form::text('string_search',null, ['class'=>'form-control','placeholder'=>'Apellidos | #Dni | #Plaza','type'=>'search']); ?>                     
                        ...
                        <div class="table-responsive" >
                                <table  class="table dataTable no-footer dtr-inline">
                                    ...
                                    <tbody id="IdShowSearch">
                                        <?php $i=0;$_plza="";?>  
                                            ...
                                            <?php $__currentLoopData = $GetSearch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $GetAllp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                            <?php $i++;?>
                                            ...
                                            <tr>
                                                <td><?php echo e($i); ?></td>
                                                <td><?php echo e($GetAllp->NroPlaza); ?></td>
                                                <td><?php echo e($GetAllp->IdNivel); ?></td>
                                                <td><?php echo e($GetAllp->cargo); ?></td>
                                                <td><?php echo e($GetAllp->Nombres); ?></td>                 
                                                <td style="text-align:center;">
                                                    <div class="ui-group-buttons">
                                                        <button type="button" class="btn btn-danger btn-lg" onclick="ShowFormBaja('<?php echo e($GetAllp->NroPlaza); ?>')">Dar Baja</button>
                                ...
                                <div style="text-align:right"> <?php echo e($GetSearch->render()); ?></div>
                        </div>                       
                        ...
                        <!--<form method="POST" action="/api/admin/gesplazas/insert"             name="frmsaveMov"  id="frmsaveMov"  enctype="multipart/form-data">-->
                                ...
                                <div class="btn-group btn-group-lg">   
                                    ...
                                    <a href="<?php echo e(URL::to('admin/bajaplazas')); ?>" class="alert alert-info alert-dismissable margin5"> Retorna a buscar[Salir]</a>
                                </div>
...
<script type="text/javascript" src="<?php echo e(asset('assets/js/api-bajaPlaza.js')); ?>"></script>
