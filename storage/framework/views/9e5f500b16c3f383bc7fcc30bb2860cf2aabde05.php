...
<header class="header">
    <a href="<?php echo e(route('admin.dashboard')); ?>" class="logo">
      <h1>EsSalud</h1> <!--<img src="<?php echo e(asset('assets/img/logo3.png')); ?>" alt="logo">-->
    </a>
                    ...
                    <ul class="sidebar_threeicons">
                        ...
                        <li>
                            <a href="<?php echo e(URL::to('admin/rpteplazas')); ?>">
                                <i class="livicon" data-name="list-ul" title="Rpte Plazas" data-loop="true"
                                   data-color="#e9573f" data-hc="#e9573f" data-s="25"></i>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(URL::to('admin/gesplazas')); ?>">
                                <i class="livicon" data-name="image" title="Plazas" data-loop="true"
